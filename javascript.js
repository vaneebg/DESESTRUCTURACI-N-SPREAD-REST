...
const combineAllArrays = (...combi) => {
    return combi.reduce((a, b) => [...a, ...b])
}

// const combineAllArrays = (...args) => { const concatenarArray = [...args]; return concatenarArray }
...
const sumAndSquare = (...numbers) => {
    const Elevar = numbers.map(number => number ** 2);
    const sum = Elevar.reduce((a, b) => a + b);
    return sum
}
console.log(sumAndSquare(2, 3, 4))